...
# =====================================================================
# ISLAMICATE DH - GAZALİ BÜYÜK VERİ / KİTAP YÜKLEME ARACI (v2 - Robust Path)
# =====================================================================
# Bu sürüm (v2), macOS terminalinde dosya sürükleyip bırakırken oluşan
# ters bölü-boşluk ("\ ") ve tırnak işaretleri gibi yol tanıma hatalarını
# otomatik olarak ayıklayan akıllı bir "Dosya Yolu Temizleyici" içerir.
# =====================================================================

def check_dependencies():
    """Gerekli kütüphanelerin kontrolünü yapar ve eksik olanları verir."""
    missing = []
    try:
        import chromadb
    except ImportError:
...
class GazaliBookIngester:
    ...
    def extract_text(self, file_path):
        """Dosya türüne göre metin içeriğini çeker."""
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("📚 İMAM GAZALİ KÜLLİYATI BÜYÜK VERİ / KİTAP YÜKLEME KONSOLU (v2)")
    print("="*60)
    ...
    try:
        ...
        print("[i] macOS kullanıcıları dosyayı doğrudan terminal penceresine SÜRÜKLEYİP BIRAKABİLİR. 🖱️")
        ...
        while True:
            ...
            # macOS terminal sürükle-bırak hatalarını düzeltme (Ters bölü boşlukları ve tırnak işaretlerini temizleme)
            file_input = file_input.strip("'\"")  # Dış tırnakları sil
            file_input = file_input.replace("\\ ", " ")  # "\ " kaçışlarını gerçek boşluğa çevir
