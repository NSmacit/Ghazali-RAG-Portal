...
# =====================================================================
# ISLAMICATE DH - GAZALI SIFIR HALÜSİNASYONLU SORU-CEVAP MOTORU (v5)
# =====================================================================
# Bu sürüm (v5), terminal oturumlarında sıkışıp kalan eski/hatalı API anahtarı
# sorununu çözmek için akıllı bir "Giriş ve Doğrulama Mekanizması" içerir.
# API anahtarınızı doğrulamadan soru-cevap moduna geçmez, böylece hataları önler.
# =====================================================================

class GazaliQueryEngine:
    def __init__(self, db_path="./gazali_chroma_db"):
        self.db_path = db_path
        self.selected_model = "gemini-1.5-flash"  # Varsayılan model
        ...
        while True:
            ...
            for model_name in self.candidate_models:
                try:
                    ...
                    # Bu model hata verdiyse listemizde bir sonrakini deniyoruz
                    continue
            ...
            if test_success:
                ...
                print("\\n[❌] API BAĞLANTI HATASI: Girdiğiniz API anahtarı geçersiz, kısıtlı veya süresi dolmuş.")
                print("[!] Lütfen https://aistudio.google.com/ adresine gidip YENİ bir anahtar oluşturun.")
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("📜 GAZALİ KÜLLİYATI SIFIR HALÜSİNASYONLU SORU-CEVAP MOTORU (v5)")
    print("="*60)
